 ...
 */
public class RunFlutterPubDowngradeHandler extends AbstractHandler {
   ...
   private void runPubDowngrade(final IProject project) {
      final var job = Job.create(Messages.Label_Flutter_Pub_Downgrade, jobMonitor -> {
         ...
         FlutterConsole.runWithConsole(jobMonitor, Messages.Label_Flutter_Pub_Downgrade, project, "pub", "downgrade");
