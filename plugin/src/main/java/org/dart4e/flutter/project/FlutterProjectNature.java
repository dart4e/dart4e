 ...
 */
public final class FlutterProjectNature implements IProjectNature {
   ...
   public static final String NATURE_ID = Dart4EPlugin.PLUGIN_ID + ".flutter.project.nature";

   public static void addToProject(final IProject project) throws CoreException {
      Projects.addNature(project, NATURE_ID, null);
      Projects.addNature(project, DartProjectNature.NATURE_ID, null);
   }
